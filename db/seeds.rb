...
Movie.create!([
    {
      ...
      description:
      %{
        A young girl is swept away into a world of spirits to save her parents. She must gain the maturity and strength to build friendships and find the bravery she needs to face a spiteful witch.
      }.squish,
      released_on: "2002-08-31",
      rating: "PG",
      total_gross: 395_845_255
    },
    {
